...
assert.deepStrictEqual(unique([9, -3, 2, -12, 0, 1, 0, 1, 2, 3, 4, 5]), [
  -12,
  -3,
  0,
  1,
...
assert.deepStrictEqual(unique([9, -3, 2, -12, 0, 1, 0, 1, 2, 3, 4, 5], 1), [[
  -12,
  -3,
  0,
  1,
...
assert.deepStrictEqual(unique([[5, 4], [5, 3], [6, 3]], 1), [[3, 4, 5, 6], [
  3,
  1,
  0,
  4,
