...
assert.deepStrictEqual(cat(0, [5, 6, 3], [0.5, -3, 2.3]), [[5, 6, 3], [
  0.5,
  -3,
  2.3,
]]);
...
assert.deepStrictEqual(cat(0, [[5, 6, 5], [7, 8, -1]], [5, 6, 3]), [[5, 6, 5], [
  7,
  8,
  -1,
], [5, 6, 3]]);
...
assert.deepStrictEqual(cat(1, [5, 6, 3], [0.5, -3, 2.3]), [[
  5,
  6,
  3,
  0.5,
...
assert.deepStrictEqual(cat(1, [[2, 3, 4]], [5, 6, 3], [0.5, -3, 2.3]), [[
  2,
  3,
  4,
  5,
