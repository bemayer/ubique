...
assert.deepStrictEqual(diag([5, 6, -3], 1), [[0, 5, 0, 0], [0, 0, 6, 0], [
  0,
  0,
  0,
  -3,
...
assert.deepStrictEqual(diag([5, 6, -3], -1), [[0, 0, 0, 0], [5, 0, 0, 0], [
  0,
  6,
  0,
  0,
...
assert.deepStrictEqual(
  diag([[0, 5, 0, 0], [0, 0, 6, 0], [0, 0, 0, -3], [0, 0, 0, 0]], 1),
  [5, 6, -3],
);

// Example 6: Extract the first subdiagonal from a matrix
assert.deepStrictEqual(
  diag([[0, 0, 0, 0], [5, 0, 0, 0], [0, 6, 0, 0], [0, 0, -3, 0]], -1),
  [5, 6, -3],
);
