...
assert.deepStrictEqual(linsolve([[1,1,-1],[1,-2,3],[2,3,1]], [[4],[-6],[7]]), [1, 2, -0.9999999999999999]);
...
assert.throws(() => linsolve([[1,1,-1],[1,-2,3]], [5, 6, 3]), Error, 'matrix dimensions must agree');

// Example 5: Throw error for non-square matrix
assert.throws(() => linsolve([[1,1],[1,-2,3]], [5, 6, 3]), Error, 'matrix must be square');

// Example 6: Throw error for singular matrix
assert.throws(() => linsolve([[1, 2], [2, 4]], [3, 6]), Error, 'matrix is singular');
