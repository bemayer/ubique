...
module.exports = function ($u: any) {
  ...
  $u.m2sortino = function (
    ...
    var _m2sortino = function (a: any, b: any, frisk: any, mar: any, t: any) {
      return $u.annreturn(a, t) +
        $u.sortino(a, frisk, mar) *
          ($u.downsiderisk(b, mar) * $u.sqrt(t) -
            $u.downsiderisk(a, mar) * $u.sqrt(t));
    };
    if ($u.isvector(x) && $u.isvector(y)) {
      return _m2sortino(x, y, frisk, mar, t);
    } else if ($u.ismatrix(x) && $u.isvector(y)) {
