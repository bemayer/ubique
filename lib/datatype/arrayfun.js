 ...
 *
 * @param {any|array|matrix} x The input array, matrix, or single value to which the function will be applied.
 * @param {Function} fun The function to apply to each element of `x`.
 * @param {...any} [funArgs] Additional arguments to pass to the function `fun` after the current element.
 * @returns {any|array|matrix} The result of applying the function to each element of the input. Returns a array, matrix, or single value based on input.
 *
 ...
 */
export default function arrayfun(x, fun, ...funArgs) {
